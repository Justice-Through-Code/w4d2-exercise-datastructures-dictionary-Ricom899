...
def favorite_restaurant():
    ...
    favorite_restaurant["name"] = input('whats your favorite restaurant?')
    favorite_restaurant["address"] = input('what is your address?')
    favorite_restaurant["favorite_dish"] = input('what is your favortie dish?')
